...
const weatherURLPreston = 'https://api.openweathermap.org/data/2.5/weather?id=5604473&appid=d6cc3373b99551fe298c6c6ad9bd5b93&units=imperial';
...
const forecastURLPreston = 'https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=d6cc3373b99551fe298c6c6ad9bd5b93&units=imperial';
...
// const weatherURLSodaSprings = 'https://api.openweathermap.org/data/2.5/weather?id=5604473&appid=d6cc3373b99551fe298c6c6ad9bd5b93&units=imperial';

// fetch (weatherURLSodaSprings)
// 	.then((response) => response.json())
// 	.then((weatherObj) => {
// 		console.log(weatherObj);
// 		document.getElementById('weather-description').textContent = weatherObj.weather[0].description;
...
// const forecastURLSodaSprings = 'https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=d6cc3373b99551fe298c6c6ad9bd5b93&units=imperial';

// fetch (forecastURLSodaSprings)
// 	.then((response) => response.json())
// 	.then((forecastObj) => {
// 		// console.log(forecastObj);
// 		let fiveDayForecast = {};
...
// const weatherURLFishHaven = 'https://api.openweathermap.org/data/2.5/weather?lat=42.0369&lon=-111.2963&appid=d6cc3373b99551fe298c6c6ad9bd5b93';

// fetch (weatherURLFishHaven)
// 	.then((response) => response.json())
// 	.then((weatherObj) => {
// 		console.log(weatherObj);
// 		document.getElementById('weather-description').textContent = weatherObj.weather[0].description;
...
// const forecastURLFishHaven = 'https://api.openweathermap.org/data/2.5/forecast?lat=42.0369&lon=-111.2963&appid=d6cc3373b99551fe298c6c6ad9bd5b93&units=imperial';

// fetch (forecastURLFishHaven)
// 	.then((response) => response.json())
// 	.then((forecastObj) => {
// 		// console.log(forecastObj);
// 		let fiveDayForecast = {};
